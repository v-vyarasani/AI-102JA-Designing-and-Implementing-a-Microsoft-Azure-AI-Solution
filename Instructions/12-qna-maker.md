...
Managed QnA Maker を使用してナレッジ ベースを作成してホストするには、Azure サブスクリプションに Text Analytics リソースが必要です。

1. `https://portal.azure.com` で Azure portal を開き、Azure サブスクリプションに関連付けられている Microsoft アカウントを使用してサインインします。
2. **「リソースの作成」** ボタンを選択し、*Text Analytics* を検索して、**Text Analytics** リソースを作成します。 
...
Text Analytics リソースにナレッジ ベースを作成するには、QnA Maker ポータルを使用できます。この場合、[Microsoft Learn](https://docs.microsoft.com/learn) に関する質問と回答を含むナレッジ ベースを作成します。
...
5. **ステップ 4** セクション:
    - **「URL」** ボックスに、`https://docs.microsoft.com/en-us/learn/support/faq` と入力し、**「URL の追加」** をクリックします。
